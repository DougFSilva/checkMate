...
public class ItemCheckListController {
	...
	@GetMapping("/{ID}")
	@Operation(
			summary = "Buscar item do checklist por ID", 
			description = "Retorna um item do checklist com base no ID fornecido."
	)
	...
	@Operation(
			summary = "Buscar itens de checklist por ID de checklist de compartimento", 
			description = "Retorna uma lista de itens de checklist associada a um checklist de compartimento."
	)
	...
	@GetMapping
	@Operation(
			summary = "Buscar todos os itens de checklist", 
			description = "Retorna uma lista de todos os itens de checklist."
	)
